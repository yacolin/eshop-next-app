...
export default function Home() {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-black">
      ...
      {/* ─── Hero Banner ─── */}
      <section className="relative mx-4 mt-4 overflow-hidden rounded-2xl md:mx-auto md:max-w-5xl">
        <div
      ...
      <section className="mt-8">
        <div className="mx-4 mb-3 md:mx-auto md:max-w-5xl">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div>
              ...
              <ul className="space-y-1.5 text-xs text-muted-foreground">
                ...
                <li><Link href="/" className="hover:text-foreground">Categories</Link></li>
                <li><Link href="/" className="hover:text-foreground">Sales</Link></li>
              </ul>
            </div>
            <div>
